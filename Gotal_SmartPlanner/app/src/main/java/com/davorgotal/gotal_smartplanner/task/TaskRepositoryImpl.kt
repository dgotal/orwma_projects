...
import com.davorgotal.gotal_smartplanner.model.DateTask
import com.davorgotal.gotal_smartplanner.model.PlaceHolderTask
...
class TaskRepositoryImpl {
    ...
    fun removeTask(id: String, listener: TaskListener) {
        db.collection("tasks").document(id).delete()
        listener.onSuccess()
    }

    fun editTask(task: Task, listener: TaskListener) {
        db.collection("tasks").document(task.id).set(task)
        listener.onSuccess()
    }

    fun addTask(task: Task, listener: TaskListener) {
        db.collection("tasks")
            .add(task)
        listener.onSuccess()
    }
